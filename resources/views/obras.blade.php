...
<td>{{$obra->autor}}</td>
    ...
    <td><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModaleditar"> editar</button>
      <a href="{{ url('/obras/destroy',$obra->id)}}"><span class="btn btn-danger">Eliminar</span></a>
...
<div class="panel-body">
  <form action="{{route('pasar')}}" method="POST">
{!! csrf_field() !!}
<p>
  <input type="text" name="titulo" placeholder="Nombre" class="form-control" required >
</p>
<p>
  <input type="text" name="creacion" placeholder="Año" class="form-control" required>
</p>
<p>
  <input type="text" name="auto" placeholder="Autor" class="form-control" required>
</p>
<p>
  <input type="text" name="descrip" placeholder="Descripcion" class="form-control"required>
</p>
