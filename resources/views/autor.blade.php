...
<tbody>
    <td> @foreach($autorVista as $autores)
  <tr>
...
<td>{{$autores->nacionalidad}}</td>
    ...
    <td><button type="button" class="btn btn-warning" data-toggle="modal" data-target="#exampleModaleditar"> editar</button>
      <a href="{{ url('/autor/destroy',$autores->id)}}"><span class="btn btn-danger">Eliminar</span></a>
</td>
...
{!! csrf_field() !!}
<p>
  <input type="text" name="llamado" placeholder="Nombre Autor" class="form-control" required >
</p>
<p>
  <input type="text" name="lugar" placeholder="Nacionalidad" class="form-control" required>
</p>
<p>
